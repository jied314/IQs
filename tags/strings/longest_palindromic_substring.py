...
class LongestPalindromicSubstring(object):
    ...
    # Similar Idea:
    #   expand the palindrome from the middle, either odd length or even length.
    # Test on LC - 1444ms, 36%
    def longest_palindrome_mid(self, s):
        if len(s) < 2:
            return 2
        longest = (0, 1)
...
def main():
    ...
    print test.longest_palindrome_nice("ccaabbaac")
    print test.longest_palindrome_mid("ccaabbaac")
