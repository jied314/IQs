...
private fun serializeRecursively(root: TreeNode?): String {
    ...
    // Use StringBuilder instead of string concatenation to reduce memory usage, since String in kotlin is immutable,
    // as in Java (each time a new memory is allocated to store the new string)
